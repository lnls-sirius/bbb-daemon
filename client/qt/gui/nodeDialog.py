...
class NodeDialog(QDialog):
    ...
    def __init__(self, parent=None, controller=None):
        ...
        self.nodeTableModel = NodeTableModel(self.nodeTable,
                                             data=self.controller.getNodesFromSector(sector=self.sectors.itemText(0),
                                                                                     registered=True))
    ...
    def scan(self):
        ...
        while self.scanning:
            self.nodeTableModel.setData(
                self.controller.getNodesFromSector(sector=self.sectors.itemText(self.sectors.currentIndex()),
                                                   registered=True))
            self.updateTypes()
    ...
    def sectorChangeEvent(self, index):
        self.nodeTableModel.setData(
            self.controller.getNodesFromSector(sector=self.sectors.itemText(index), registered=True))
