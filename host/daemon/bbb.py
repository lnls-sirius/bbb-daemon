...
class BBB:
    ...
    def update_ip_address(self, dhcp_manual, new_ip_address="0.0.0.0", new_mask="0.0.0.0", new_gateway="0.0.0.0", nameserver_1 = "0.0.0.0", nameserver_2 = "0.0.0.0"):
        """
        ...
        if self.node.ip_address != new_ip_address:
            ...
            self.change_ip_address(dhcp_manual, new_ip_address, new_mask, new_gateway, nameserver_1, nameserver_2)
    ...
    def change_ip_address(self, dhcp_manual, new_ip_address="0.0.0.0", new_mask="0.0.0.0", new_gateway="0.0.0.0", nameserver_1 = "0.0.0.0", nameserver_2 = "0.0.0.0"):
        """
        ...
        if (nameserver_1 == '0.0.0.0') and (nameserver_2 == '0.0.0.0'):
            subprocess.check_output(['connmanctl config {} --ipv4 {} {} {} {}'.format(service, dhcp_manual, new_ip_address, new_mask,new_gateway)], shell=True)
        else:
            subprocess.check_output(['connmanctl config {} --ipv4 {} {} {} {} --nameservers {} {}'.format(service, dhcp_manual, new_ip_address, new_mask,new_gateway,nameserver_1, nameserver_2)], shell=True)
